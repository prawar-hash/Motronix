...
const Marketplace = () => {
  ...
  // Indian-centric dropdown values
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
      ...
      <div className="bg-slate-900 border border-dark-border rounded-2xl p-6 shadow-md space-y-4">
        <form onSubmit={handleSearchSubmit} className="flex flex-col sm:flex-row gap-3">
          <div className="relative flex-grow">
            ...
            <input
              ...
              placeholder="Search by brand (e.g. Royal Enfield), model (e.g. Classic 350)..."
              className="w-full bg-slate-950 border border-dark-border rounded-xl py-3 pl-11 pr-4 text-white text-sm focus:outline-none focus:border-primary"
            />
          </div>
          <button
            type="submit"
        ...
        <div className="flex flex-wrap items-center gap-4 pt-2 text-sm text-gray-300">
          <div className="flex items-center space-x-1.5 text-gray-400 shrink-0">
            ...
            <span className="font-bold uppercase tracking-wider text-xs">Filter:</span>
          </div>
          ...
          <select
            ...
            className="bg-slate-950 border border-dark-border text-white text-xs font-semibold py-2.5 px-3.5 rounded-lg focus:outline-none focus:border-primary"
          >
          ...
          <input
            ...
            className="bg-slate-950 border border-dark-border text-white text-xs py-2 px-3.5 rounded-lg focus:outline-none focus:border-primary w-36"
          />
      ...
      {loading ? (
        ...
        <div className="bg-rose-500/10 border border-rose-500/20 text-rose-400 p-8 rounded-2xl text-center space-y-4 max-w-lg mx-auto">
          ...
          <h3 className="font-bold text-lg text-white">Database Error</h3>
        ...
        <div className="bg-slate-900 border border-dark-border rounded-2xl py-16 text-center space-y-4">
